# <div align="center">![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Imalka%20Perera&fontSize=50&fontColor=fff&animation=fadeIn&fontAlignY=35&desc=Code%20Wizard%20%7C%20Bug%20Slayer%20%7C%20Tech%20Adventurer&descAlignY=55&descSize=18)</div>
...
const imalka = {
    ...
    location: "Sri Lanka 🇱🇰",
    education: "Computer Science @ IIT Sri Lanka",
    university: "University of Westminster",
    
    currentlyLearning: ["Java", "React.js", "Node.js"],
    interests: ["Web Development", "AI/ML", "Open Source"],
    
    funFacts: {
        coffeeConsumedDaily: "∞",
        favoriteEditor: "VS Code",
        currentGoal: "Build amazing SaaS products"
    },
    
    askMeAbout: [
        "Web Development", "Programming", 
        "Tech Trends", "Career Advice"
    ]
};
```
...
<img src="https://skillicons.dev/icons?i=react,nodejs,express,tailwind,bootstrap,jquery&theme=dark" />

### 🛠️ Tools & Platforms
<img src="https://skillicons.dev/icons?i=vscode,git,github,figma,aws,docker&theme=dark" />
...
<img src="https://img.shields.io/badge/Portfolio-FF5722?style=for-the-badge&logo=web&logoColor=white&labelColor=FF5722&color=FF5722" alt="Portfolio" />
</a>
...
### 💬 Ask me about:
**Web Development • Full-Stack • React • Java • Career Advice • Tech Trends**
